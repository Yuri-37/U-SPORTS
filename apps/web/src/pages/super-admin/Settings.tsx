        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-[var(--text-muted)] mb-3">
              JPEG, PNG, WebP, or SVG · max 5MB · visible across login, guest pages, sidebar, and
              live displays.
            </p>
              ...
              <div className="flex gap-2 items-center">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    applyTheme(e.target.value, form.secondary_color)
                  }}
              ...
              <div className="flex gap-2 items-center">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    applyTheme(form.primary_color, e.target.value)
                  }}
                  className="w-10 h-10 rounded cursor-pointer"
                />
                <Input
