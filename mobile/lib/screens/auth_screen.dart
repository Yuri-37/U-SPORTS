...
class _AuthScreenState extends ConsumerState<AuthScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      final profile = await Supabase.instance.client.from('profiles').select('role').eq('id', res.user!.id).maybeSingle();
      if (!mounted) return;
            ...
            children: [
                  ...
                  return Column(
                    children: [
                      ...
                      Text(
                        'U-Sports',
                        textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900, letterSpacing: -0.5, color: onSurface),
                      ),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.mail_outline, color: LayoutTokens.secondaryText(context)),
                ),
              ),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  labelText: 'Password',
                  prefixIcon: Icon(Icons.lock_outline, color: LayoutTokens.secondaryText(context)),
                ),
              ),
              const SizedBox(height: 8),
              GestureDetector(
